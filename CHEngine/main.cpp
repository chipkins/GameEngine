...
int main()
{
	...
	engine.createObject("stallBase", "Textures/telephone-poll.jpg", glm::vec3(0, -0.62, 0.5), glm::vec3(0, 0, 0), glm::vec3(1, 0.25, 1), none);
	...
	engine.createObject("stallTop", "Textures/wood_texture.jpg", glm::vec3(0, 0.25, -1), glm::vec3(0, 0, 0), glm::vec3(1, 0.25, 1), none);
	engine.objs["stallTop"].initPhysics(Shape::noCollide, glm::vec3(), glm::vec3(), 1.0f);
	engine.createObject("birdLow", "Textures/pigeon.png", glm::vec3(-0.5, -0.32, 0.25), glm::vec3(0, 0, 0), glm::vec3(0.1, 0.1, 1), bounce);
	engine.objs["birdLow"].initPhysics(Shape::aabb, glm::vec3(0.5, 0.0f, 0.0f), glm::vec3(), 1.0f);
	engine.createObject("birdMid", "Textures/pigeon.png", glm::vec3(0, 0.1, -0.5), glm::vec3(0, 0, 0), glm::vec3(0.1, 0.1, 1), bounce);
	engine.objs["birdMid"].initPhysics(Shape::aabb, glm::vec3(0.5f, 0.0f, 0.0f), glm::vec3(), 1.0f);
	engine.createObject("birdHigh", "Textures/pigeon.png", glm::vec3(0.5, 0.6, -1.5), glm::vec3(0, 0, 0), glm::vec3(0.1, 0.1, 1), bounce);
	engine.objs["birdHigh"].initPhysics(Shape::aabb, glm::vec3(0.5f, 0.0f, 0.0f), glm::vec3(), 1.0f);
	engine.createObject("gun", "Textures/shotgun2.png", glm::vec3(0.75, -0.75, 1), glm::vec3(0, 0, 0), glm::vec3(0.25, 0.25, 1), none);
